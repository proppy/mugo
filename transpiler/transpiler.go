...
// transpiler transpiles a subset of the Go language to Arduino flavour of C++.
package transpiler
...
// Transpile reads Go source code from a given input stream and writes
// transpiled Arduino C++ source code to the given output stream.
